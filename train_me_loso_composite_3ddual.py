...
from capsule.data import data_split, sample_data, get_meta_data, Datasetcom, MyDatasetTranscom , MyDatasetDualcom
...
def load_me_data(data_root, data_root_3d,file_path, subject_out_idx, batch_size=4, num_workers=1,is_3d=True,is_fusion=True):
...
if __name__ == '__main__':
	...
	for i in range(28):         ##### casme has 24 subjects , smic has subject 16, samm has subject28  com has subjects 28
