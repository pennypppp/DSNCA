...
lr = 0.0001   # lr = 0.0001(ori)   lr=0.0002    lr=0.00005
lr_decay_value = 0.9
num_classes = 3
epochs = 30
...
def load_me_data(data_root, data_root_3d,file_path, subject_out_idx, batch_size=32, num_workers=1,is_3d=True,is_fusion=True):
...
def train_eval(subject_out_idx):
	...
	# model = MECapsuleNetDual(classes=num_classes, routings=3, is_freeze=False)
	model.cuda()
	...
	for epoch in range(epochs):
		...
		print("==> Subject out: %02d - Epoch %02d: loss=%.5f, train_acc=%.5f, val_loss=%.5f, "
		      ...
		      % (subject_out_idx, epoch, train_loss, train_acc,
		         test_loss, test_acc))
		log_f.write('\nSubject out: %02d - Epoch %02d: loss=%.5f, train_acc=%.5f, val_loss=%.5f, val_acc=%.4f}\n'%( \
...
if __name__ == '__main__':
	...
	for i in range(28):         ##### casme has 24 subjects , smic has subject 16, samm has subject28
