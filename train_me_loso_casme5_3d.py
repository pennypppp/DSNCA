...
#casme
data_apex_frame_path = '/home/pp/FP_program/CAPSULE3d_dualca/datasets/camse2_apex_5.csv'
data_four_frames_path = '/home/pp/FP_program/CAPSULE3d_dualca/datasets/casme_four_apex_5.csv'
...
def train_eval(subject_out_idx):
	...
	model = MECapsuleNet(input_size=(3, 224, 224), classes=num_classes, routings=3, is_freeze=False)     ##################3
...
if __name__ == '__main__':
	...
	for i in range(26):         ##### casme has 26 subjects , smic has subject 16, samm has subject20
