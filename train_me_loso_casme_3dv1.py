...
from capsule.data import data_split, sample_data, get_meta_data, MyDataset3d
...
data_apex_frame_path = '/home/pp/FPprogram/CAPSULE3d/datasets/casme_apex_3.csv'
# data_four_frames_path = '//home/pp/program-pp/CapsuleNet-for-Micro-Expression-Recognition1/me_recognition-master/datasets/data_four_frames.csv'
# save3d_root = 'casmeapex'
data_root_2d = '/home/pp/DATASET'
data_root_3d = '/home/pp/DATASET/output3d/casmeapex'
...
def load_me_data(data_root_2d,data_root_3d, file_path, subject_out_idx, batch_size=32, num_workers=1):
	...
	train_paths, train_labels = get_meta_data(df_train)    #get the 3d apex path for training
	...
	train_dataset = MyDataset3d(data_root_2d=data_root_2d,
								data_root_3d=data_root_3d,
								apex2d_paths=train_paths,
	...
	val_dataset = MyDataset3d(data_root_2d=data_root_2d,
							  data_root_3d=data_root_3d,
							  apex2d_paths=val_paths,
...
def train_eval(subject_out_idx):
	...
	# Model & others
	model = MECapsuleNet(input_size=(42, 224, 224), classes=num_classes, routings=3, is_freeze=False)    ############### original inputsize(3,224,224)  3dinpust_size(42,224,224)
	model.cuda()
	...
	for epoch in range(epochs):
		train_loader, test_loader = load_me_data(data_root_2d, data_root_3d,data_apex_frame_path,
...
if __name__ == '__main__':
	for i in range(24):         ##### casme has 24 subjects
		...
		with open('trained/scores_capsule_resnet_sampled_fer_freeze.pkl', 'wb') as file:
